"""Bounded LR launcher controls plus one tiny CPU prefix; no real corpus/GPU."""
...
import numpy as np
import torch
from scripts import run_babylm_indexer_lr_probe_v0 as probe
...
class ProbeTests(unittest.TestCase):
    ...
    def test_tiny_engine_prefix_saves_optimizer_rng_panel_and_full_lr_horizon(self):
        ...
        p = {"schema_version": 1, "scope": "engineering_smoke", "launch_allowed": True,
             ...
             "learning_rate": 3e-4, "indexer_learning_rate": 1e-4, "weight_decay": 0.1,
        ...
        self.assertEqual(result["last_lr"]["indexer"], 1e-4 * multiplier)
