...
def main(a):
 ...
 pp=R/'provenance/task-attention-phases-full-protocol.json';phase_protocol=read(pp)
 ...
 assert len(rows)==len(chosen)==72;placements={x['item_id']:x for x in phase_protocol['rows']}
