...
def main(a):
    out = ROOT/'results'/f'flashmoba-mixed-cost-{a.precision}-{a.length}-v2'
    ...
    try:
        ...
        save(out/'manifest.json',dict(started_utc=started,precision=a.precision,length=a.length,
            ...
            config_sha256=sha(ROOT/'configs/flashmoba-mixed-cost-v2.json'),initial_adapters_sha256=initial,
