...
def main(a):
 ...
 protocol=json.loads((R/'provenance/lambada-natural-retry-protocol-v0.json').read_text());job=next(x for x in protocol['jobs'] if x['name']==a.job)
