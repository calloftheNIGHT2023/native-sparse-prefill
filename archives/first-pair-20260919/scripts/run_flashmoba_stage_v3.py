...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'results/flashmoba-batch-v3';OUT.mkdir(parents=True,exist_ok=False)
...
try:
    ...
    env=ROOT/'results/flashmoba-environment-headers-v2/environment.json'
    ...
    original_gate='results/flashmoba-official-gate-v1/verification.json'
