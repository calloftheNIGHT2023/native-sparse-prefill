"""Fixed-config short LoRA trajectories; separates backward noise from routing changes."""
import os
...
def main(a):
    ...
    try:
        ...
        for cond in cfg['conditions']:
            ...
            del optimizer,final
        pairs=[]
        for left,right,kind in [('dense32','dense128','dense_control'),('official32a','official32b','same_config_repeat'),
            ('official32a','official64','config_change'),('official32a','official128','config_change'),('official64','official128','config_change'),
            ('fp3232','fp3264','fp32_config_change'),('fp3232','fp32128','fp32_config_change'),('fp3264','fp32128','fp32_config_change')]:
