...
def main(a):
 ...
 protocol=json.loads((R/'provenance/common-dense-quality-protocol-v0.json').read_text());job=next(x for x in protocol['jobs'] if x['name']==a.job)
