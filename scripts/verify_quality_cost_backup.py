...
archive = ROOT / 'exports/flashmoba-quality-cost-cloud-stage-v0.tar.gz'
proof = json.loads((ROOT / 'exports/flashmoba-quality-cost-cloud-stage-v0.json').read_text(encoding='utf-8'))
...
with tarfile.open(archive, 'r:gz') as tar:
    ...
    manifest_name = 'results/flashmoba-quality-cost-package-v0/archive-manifest.json'
...
out = ROOT / 'provenance/flashmoba-quality-cost-local-verification-v0.json'
