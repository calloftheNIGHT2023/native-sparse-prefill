...
from scripts import run_babylm_dw_seed_confirmation_v0 as q


def main():
    out = ROOT / 'logs/babylm-dw-seed-controller-tests-20260921-v1'
    ...
    master = {'backbone_seed': 20260921, 'source_sha256': {'placeholder': 'only_static'},
              'train_timeout_seconds': 10800, 'hardware': {'physical_uuid': 'GPU-test', 'driver_version': 'test'}}
    d = copy.deepcopy(reference)
    d.update(backbone_seed=20260921, source_sha256=master['source_sha256'], scientific_condition='D_dense',
             actual_policy='dense', engine_compatibility_mode='dense', max_wall_seconds=10700,
    ...
    for key, value in [('learning_rate', 0.001), ('data_order_seed', 0), ('max_epochs', 2),
                       ('backbone_seed', 20260917), ('max_wall_seconds', 10800), ('scope', 'gpu_preflight')]:
