...
OUT=ROOT/'results/flashmoba-backward-environment-v2';OUT.mkdir(parents=True,exist_ok=False)
...
try:
    ...
    run('torch',[py,'-m','pip','install','--no-cache-dir','torch==2.8.0','--index-url','https://download.pytorch.org/whl/cu128'],timeout=1500)
