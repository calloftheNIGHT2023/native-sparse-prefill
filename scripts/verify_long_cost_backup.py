...
archive = ROOT / 'exports/flashmoba-long-cost-cloud-stage-v0.tar.gz'
proof = json.loads((ROOT / 'exports/flashmoba-long-cost-cloud-stage-v0.json').read_text(encoding='utf-8'))
...
with tarfile.open(archive, 'r:gz') as tar:
    ...
    manifest_name = 'results/flashmoba-long-cost-package-v0/archive-manifest.json'
...
out = ROOT / 'provenance/flashmoba-long-cost-local-verification-v0.json'
